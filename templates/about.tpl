<div class="row">
    ...
    <p>
        ...
        eastern Pennsylvania, but opportunities to travel to more interesting
        destinations exist as well.
    </p>
    <p>
    ...
    <p>
        ...
        a temporary website with a complete list of planned events for 2013.
    </p>
    <p>
        The name is borrowed from from a previous State College-based dive
        shop named Blue Lion SCUBA which was owned and operated by Ann
    ...
    <p>
        Paul earned his <a href="http://www.naui.org">NAUI</a> instructor
        certification in 2002 and has since taught hundreds of people to
        safely scuba dive.
    </p>
    <p>
