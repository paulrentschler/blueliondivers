<div class="row">
    ...
    <p>
        ...
        dive safely. Certifying agencies setup courses to teach
        these minimum standards (and typically more) to people who
        want to scuba dive. Upon successful demonstration of these
        skills a certifying agency issues a certification card to
        the student which then allows them to purchase scuba diving
        equipment, get air fills, and get aboard dive boats.
    </p>
    <p>
        Most entry level scuba diving courses are divided into
        three parts: academic learning, pool practice, and open
        water demonstration. Typically the academic and pool practice
        are combined into one course and the open water demonstration
        or certification dives are offered separately. This is done
        because not everyone wants to do their open water dives in
        the quarries of central Pennsylvania. Once you successfully
        complete the academic and pool portions of the course, you
    ...
    <p>
        ...
        snorkel, boots, and fins. Cost depends on the brand and style of
        each item you select but average cost is around $200.
    </p>
    <p>
    ...
    <p>
        ...
        ability and comfort in the water are key necessities for a
        successful scuba course.
    </p>
    <p>
    ...
    <p>
        ...
        instructor in conjunction with your physician. A medical assessment
        is done as part of the course and you may be required to obtain a
    ...
    <p>
        ...
        have not dove in a year or more that you obtain a refresher before
        doing dives on your own. This allows you to refresh your academic
    ...
    <p>
        ...
        In the United States the three biggest agencies are:
        <ul>
            <li>
                <a href="http://www.naui.org">NAUI
                    - National Association of Underwater Instructors</a>
            </li>
            <li>
                <a href="http://www.padi.com">PADI
                    - Professional Association of Diving Instructors</a>
            </li>
            <li>
                <a href="http://www.divessi.com/">SSI
                    - Scuba Schools International</a>
            </li>
        </ul>
        No one agency is particularly better than another; they all have
